...
class VectorQuant(_VQBaseLayer):
	...
	def __init__(
		...
		self.rotation_scale_min = kwargs.pop("rotation_scale_min", None)
		self.rotation_scale_max = kwargs.pop("rotation_scale_max", None)
	...
	def rot_trick(self, z, z_q):
		...
		z_q_rt = rotation_trick(
			z,
			z_q,
			scale_min=self.rotation_scale_min,
			scale_max=self.rotation_scale_max,
		)
