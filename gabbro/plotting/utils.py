...
DEFAULT_LABELS = {
    ...
    "L1T_PUPPIPart_Eta": r"PUPPI particle $\eta / 3$",
    "L1T_PUPPIPart_Phi_cos": r"PUPPI particle $\cos\phi$",
    "L1T_PUPPIPart_Phi_sin": r"PUPPI particle $\sin\phi$",
    "L1T_PUPPIPart_PT": r"PUPPI particle $\log(p_T) - 1.8$",
    "L1T_JetAK4_Eta": r"AK4 jet $\eta / 3$",
    "L1T_JetAK4_Phi_cos": r"AK4 jet $\cos\phi$",
    "L1T_JetAK4_Phi_sin": r"AK4 jet $\sin\phi$",
    "L1T_JetAK4_PT": r"AK4 jet $\log(p_T) - 1.8$",
    "L1T_JetAK8_Eta": r"AK8 jet $\eta / 3$",
    "L1T_JetAK8_Phi_cos": r"AK8 jet $\cos\phi$",
    "L1T_JetAK8_Phi_sin": r"AK8 jet $\sin\phi$",
    "L1T_JetAK8_PT": r"AK8 jet $\log(p_T) - 1.8$",
    "L1T_JetPuppiAK4_Eta": r"PUPPI AK4 jet $\eta / 3$",
    "L1T_JetPuppiAK4_Phi_cos": r"PUPPI AK4 jet $\cos\phi$",
    "L1T_JetPuppiAK4_Phi_sin": r"PUPPI AK4 jet $\sin\phi$",
    "L1T_JetPuppiAK4_PT": r"PUPPI AK4 jet $\log(p_T) - 1.8$",
    "L1T_JetPuppiAK8_Eta": r"PUPPI AK8 jet $\eta / 3$",
    "L1T_JetPuppiAK8_Phi_cos": r"PUPPI AK8 jet $\cos\phi$",
    "L1T_JetPuppiAK8_Phi_sin": r"PUPPI AK8 jet $\sin\phi$",
    "L1T_JetPuppiAK8_PT": r"PUPPI AK8 jet $\log(p_T) - 1.8$",
}
DEFAULT_COLORS = [
    # "steelblue",
    # "orange",
